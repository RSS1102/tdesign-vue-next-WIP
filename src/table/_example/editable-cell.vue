...
import { Input, Select, DatePicker, MessagePlugin, PrimaryTableCellParams, TableErrorListMap } from 'tdesign-vue-next';
...
const editableCellState = (cellParams: PrimaryTableCellParams<DataType>) => {
  // 第一行不允许编辑
...
const validateTableData = () => {
  // 仅校验处于编辑态的单元格
  tableRef.value.validateTableData().then((result: TableErrorListMap) => {
